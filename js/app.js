...
function initializeClock(id, endtime) {
	...
	function updateClock() {
		...
		//обратный отсчет и при окончании снова запуск впримере 5сек
		// if (t.total <= 0) {
		// 	clearInterval(timeinterval);
...
var deadline = "july 7 2021 00:00:00 GMT+0300";
...
// var deadline = new Date(Date.parse(new Date()) + 1 * 23 * 60 * 60 * 1000); // for endless timer 1 день

initializeClock('countdown', deadline);
//initializeClock('countdown-2', deadline); второй счетчик
...
if (document.querySelector('.loveline-slider')) {
	let slider_about = new Swiper('.loveline-slider__body', {
		/*
		effect: 'fade',
		autoplay: {
			delay: 3000,
		...
		*/
		...
		// Arrows
		navigation: {
			nextEl: '.loveline-slider__arrow_next',
			prevEl: '.loveline-slider__arrow_prev',
		},
...
if (document.querySelector('.poper-slider')) {
	let slider_about = new Swiper('.poper-slider__slider', {
		/*
		effect: 'fade',
		autoplay: {
			delay: 3000,
		...
		*/
		...
		// Arrows
		navigation: {
			nextEl: '.poper-slider__arrow_next',
			prevEl: '.poper-slider__arrow_prev',
		},
		/*
		breakpoints: {
			320: {
